...
namespace mat::demo {
    ...
    bool DemoApp::initialize() {
        ...
        _impl->hwnd = ::CreateWindowExW(
            0, windowClass.lpszClassName, L"matVkEngine Render Graph Demo", WS_OVERLAPPEDWINDOW, 100, 100,
            static_cast<int>(g_width * dpiScale), static_cast<int>(g_height * dpiScale), nullptr, nullptr,
    ...
    void DemoApp::run() {
        while (_impl->running) {
            ...
            _impl->editor.draw(_impl->document);
