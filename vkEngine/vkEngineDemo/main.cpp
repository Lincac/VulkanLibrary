...
{
public:
	Instance(const std::string& applicationName, bool enableValidationLayers = true)
...
public:
    ...
    PhysicalDevice(VkInstance instance, GLFWwindow* window)
    {
...
public:
    Swapchain(VkPhysicalDevice physicalDevice, VkDevice logicalDevice, VkSurfaceKHR surface, GLFWwindow* window)
    {
        ...
        for (uint32_t i = 0; i < _swapChainImages.size(); i++) {
            _swapChainImageViews[i] = createImageView(_swapChainImages[i], _swapChainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT, logicalDevice);
        }
    }
