...
vkEngineSwapChain::vkEngineSwapChain(vkEngineLogicalDevice& device, GLFWwindow* window)
    : _device(device)
{
    ...
    createInfo.surface = physicalDevice.getVkEngine().getSurfaceKHR();
    ...
    auto indices = physicalDevice.findQueueFamilies(physicalDevice._physicalDevice);;
...
#include <algorithm>
VkExtent2D vkEngineSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities, GLFWwindow* window)
{
