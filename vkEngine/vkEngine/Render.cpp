...
{
    VkShaderModule vertShaderModule = _engine->createShader("../Dependence/shaders/bin/OpaqueShader.vert.spv", Vertex);
    VkShaderModule fragShaderModule = _engine->createShader("../Dependence/shaders/bin/OpaqueShader.frag.spv", Fragment);
